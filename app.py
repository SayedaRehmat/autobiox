...
def generate_pdf(subtype, mutation_results):
    ...
    pdf.cell(0, 10, "🧬 Predicted Subtype:", ln=True)
    pdf.set_font("Arial", '', 12)
    ...
    if mutation_results:
        pdf.ln(5)
        pdf.set_font("Arial", 'B', 14)
        pdf.cell(0, 10, "💊 Mutation-Drug Matches:", ln=True)
        pdf.set_font("Arial", '', 12)
...
if st.button("📄 Generate Clinical Report (PDF)"):
    ...
    st.download_button("📥 Download Report", data=open(pdf_path, "rb"), file_name="AutoBioX_Report.pdf")
